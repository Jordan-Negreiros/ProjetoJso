package br.com.projetojsp.beans;
...
public class BeanCursoJsp {
    ...
    private boolean atualiarImagem = true;
    private boolean atualiarPdf = true;
    private String sexo;
    ...
    public boolean isAtualiarImagem() {
        return atualiarImagem;
    }

    public void setAtualiarImagem(boolean atualiarImagem) {
        this.atualiarImagem = atualiarImagem;
    }

    public boolean isAtualiarPdf() {
        return atualiarPdf;
    }

    public void setAtualiarPdf(boolean atualiarPdf) {
        this.atualiarPdf = atualiarPdf;
    }
